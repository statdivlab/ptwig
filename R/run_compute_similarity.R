#' Run computation of similarity function
#'
#' @param newicks1 Character vector of Newick strings for first tree(s) (optional).
#' @param newicks2 Character vector of Newick strings for second trees(s) or target tree (optional).
#' @param file1 Path to a file containing Newick trees for first tree(s) (optional).
#' @param file2 Path to a file containing Newick trees for second trees(s) or target tree (optional).
#'
#' @return Output of computeSimilarity
#' @export
#'
#' @importFrom ape read.tree
run_compute_similarity <- function(newicks1 = NULL, newicks2 = NULL,
