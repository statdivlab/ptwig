...
#'
#' @return Output of computeFDP
#' @export
#'
#' @importFrom ape read.tree
run_compute_FDP <- function(newicks1 = NULL, newicks2 = NULL,
  ...
  if (n2 == 1){
    res <- lapply(cleaned_newicks1, function(x) computeFDP(x, cleaned_newicks2[1]));
  } else {
    res <- lapply((1:n1), function(x) computeFDP(cleaned_newicks1[x],cleaned_newicks2[x]))
  }
